...
const googleTagSnippet = `
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-XVB04MP13V"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-XVB04MP13V');
    </script>`;
const defaultNav = [
  ["Admin", "/admin/"],
...
const pages = [
  ...
  },
  {
    ...
    body: `
      ...
      <section class="doc-content" aria-label="Brand guidance">
        ...
        <section><h2>UI Tone</h2><p>PostSnail UI should feel like a fast handmade tool: crisp borders, square corners, strong labels, honest copy, lightweight analytics when explicitly requested, and no platform-lock-in language.</p><p>Public pages can be expressive. The admin stays compact and task-first because creators use it repeatedly to write, verify, back up, and export.</p></section>
      </section>
    `,
  },
  {
  ...
  },
  {
    ...
    body: docPage("Headless publishing sections", "Headless Publishing", "Local automation should use the same Shell, signing, export, and verification rules as the browser admin.", [
      ...
      ["commands", "Current Commands", "The CLI includes menu, workspace, profile, identity, plugin, post, page, asset, comment, build, zip, verify, live verify, publish surge, forest announce, shellname, and domain move/mirror commands."],
    ]),
  },
  {
  ...
  },
  {
    ...
    body: docPage("Security sections", "Security Notes", "PostSnail protects editable source data with local encryption and public accountability with signed proof files, but those are different guarantees.", [
      ...
      ["backend", "No Required Backend", "The admin does not need accounts, upload services, or registry calls. The public PostSnail site may include lightweight analytics, but Forest registration is still a separate public-site action after publishing."],
    ]),
  },
  {
    ...
    body: `
      ...
      <article class="doc-layout">
        ...
        <div class="doc-content">
          ...
          <section id="third-party"><h2>Third-Party Code</h2><p>No proprietary third-party code was found in the shipped vendored dependency set during the Alpha 2 review. The browser libraries are open-source: noble packages, fflate, marked, CodeMirror, and Lezer are MIT; DOMPurify is available under Apache-2.0 or MPL-2.0.</p><p>See <code>THIRD_PARTY_NOTICES.md</code> in the repository for versions, licenses, copyright notices, and bundled license file paths.</p></section>
